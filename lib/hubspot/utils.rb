  ...
  class Utils
    class << self
      ...
      def dump_properties(klass, hapikey=ENV['HUBSPOT_API_KEY'], filter={})
        DeprecatedHubspot::Deprecator.build.deprecation_warning("DeprecatedHubspot::Utils.dump_properties")
      ...
      def restore_properties(klass, hapikey=ENV['HUPSPOT_API_KEY'], properties={}, dry_run=false)
        DeprecatedHubspot::Deprecator.build.deprecation_warning("DeprecatedHubspot::Utils.restore_properties")
      ...
      def with_hapikey(hapikey)
        begin
          DeprecatedHubspot.configure(hapikey: hapikey) unless hapikey.blank?
          yield if block_given?
        ensure
          DeprecatedHubspot.configure(hapikey: ENV['HUBSPOT_API_KEY']) unless hapikey.blank?
        end
      end
