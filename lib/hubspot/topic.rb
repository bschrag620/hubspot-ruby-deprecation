module DeprecatedHubspot
  ...
  class Topic
    ...
    class << self
      ...
      # @return [DeprecatedHubspot::Topic] array of topics
      def list
        response = DeprecatedHubspot::Connection.get_json(TOPICS_PATH, {})
      ...
      # @return DeprecatedHubspot::Topic
      def find_by_topic_id(id)
        response = DeprecatedHubspot::Connection.get_json(TOPIC_PATH, { topic_id: id })
        new(response)
      end
    end
