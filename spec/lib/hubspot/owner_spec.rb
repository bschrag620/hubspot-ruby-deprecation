describe DeprecatedHubspot::Owner do
  ...
  describe '.all' do
    ...
    it 'should find all owners' do
      owners = DeprecatedHubspot::Owner.all
  ...
  describe '.find_by_email' do
    ...
    it 'should find a user via their email address' do
      owner = DeprecatedHubspot::Owner.find_by_email(email)
  ...
  describe '.find_by_emails' do
    ...
    it 'should find users via their email address' do
      owners = DeprecatedHubspot::Owner.find_by_emails(emails)
